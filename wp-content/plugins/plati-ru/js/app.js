...
jQuery(document).ready(function(){
    jQuery('#additional_info_collapse').on(
		'shown.bs.collapse',
		function () {
			jQuery("#additional_info_toggle").removeClass("glyphicon-chevron-down").addClass("glyphicon-chevron-up");
		}
	);
    jQuery('#additional_info_collapse').on(
		'hidden.bs.collapse',
		function () {
			jQuery("#additional_info_toggle").removeClass("glyphicon-chevron-up").addClass("glyphicon-chevron-down");
		}
	);
});
